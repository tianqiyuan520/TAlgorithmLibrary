...
execute as @e[tag=tal.a_star.new_] unless entity @e[tag=tal.a_star.return] if score #tal.a_star.limit tal.a_star.temp matches ..500 run function t_algorithm_lib:others/find_path/a_star/3d/loop/loop_check
# function t_algorithm_lib:others/find_path/a_star/3d/loop/d
