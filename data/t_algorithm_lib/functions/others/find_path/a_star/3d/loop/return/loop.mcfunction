...
execute unless entity @e[tag=tal.a_star.end_back,distance=..10] run function t_algorithm_lib:others/find_path/a_star/3d/end/start

execute as @e[tag=tal.a_star.end_back,limit=1,sort=nearest] at @s run function t_algorithm_lib:others/find_path/a_star/3d/loop/return/loop
# execute as @e[tag=tal.a_star.end_back,limit=1,sort=nearest] at @s run schedule function t_algorithm_lib:others/find_path/a_star/3d/loop/return/start 1t replace 
