...
execute if score #tal.sign_version tal.input matches 2 run data modify block -29999999 3 20228222 front_text.messages[3] set value '{"nbt": "temp.item_AttributeModifiers.feet[0]","storage": "t_algorithm_lib:item_to_json","interpret": true}'
