...
execute store result score #tal.o.ITJ.number1 tal.str_parser run data get storage t_algorithm_lib:item_to_json temp.HideFlags_list[-1]
data remove storage t_algorithm_lib:item_to_json temp.item_Enchantments
execute unless score #tal.o.ITJ.number1 tal.str_parser matches 1 if data storage t_algorithm_lib:item_to_json temp.item.tag.Enchantments run data modify storage t_algorithm_lib:item_to_json temp.item_Enchantments set from storage t_algorithm_lib:item_to_json temp.item.tag.Enchantments
