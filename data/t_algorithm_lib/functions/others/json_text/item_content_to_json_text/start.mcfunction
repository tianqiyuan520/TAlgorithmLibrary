...
execute store result score #tal.o.ITJ.item.HideFlags tal.str_parser run data get storage t_algorithm_lib:item_to_json temp.item.tag.HideFlags
scoreboard players operation #tal.array.decimal_to_binary.num tal.str_parser = #tal.o.ITJ.item.HideFlags tal.str_parser
...
execute unless score #tal.o.ITJ.number1 tal.str_parser matches 1 run function t_algorithm_lib:others/json_text/item_content_to_json_text/firework/start
##书本 成书
execute store result score #tal.o.ITJ.number1 tal.str_parser run data get storage t_algorithm_lib:item_to_json temp.HideFlags_list[-6]
execute unless score #tal.o.ITJ.number1 tal.str_parser matches 1 if data storage t_algorithm_lib:item_to_json temp.item{id:"minecraft:written_book"} run function t_algorithm_lib:others/json_text/item_content_to_json_text/written_book/start
##地图map
execute store result score #tal.o.ITJ.number1 tal.str_parser run data get storage t_algorithm_lib:item_to_json temp.HideFlags_list[-6]
execute unless score #tal.o.ITJ.number1 tal.str_parser matches 1 if data storage t_algorithm_lib:item_to_json temp.item{id:"minecraft:filled_map"} run function t_algorithm_lib:others/json_text/item_content_to_json_text/map
##药水效果CustomPotionEffects
execute store result score #tal.o.ITJ.number1 tal.str_parser run data get storage t_algorithm_lib:item_to_json temp.HideFlags_list[-6]
execute unless score #tal.o.ITJ.number1 tal.str_parser matches 1 if data storage t_algorithm_lib:item_to_json temp.item{id:"minecraft:potion"} run function t_algorithm_lib:others/json_text/item_content_to_json_text/custom_potion_effects/start
execute unless score #tal.o.ITJ.number1 tal.str_parser matches 1 if data storage t_algorithm_lib:item_to_json temp.item{id:"minecraft:lingering_potion"} run function t_algorithm_lib:others/json_text/item_content_to_json_text/custom_potion_effects/start
execute unless score #tal.o.ITJ.number1 tal.str_parser matches 1 if data storage t_algorithm_lib:item_to_json temp.item{id:"minecraft:splash_potion"} run function t_algorithm_lib:others/json_text/item_content_to_json_text/custom_potion_effects/start

##附魔
function t_algorithm_lib:others/json_text/item_content_to_json_text/enchantments/start
##皮革盔甲的"color"
execute store result score #tal.o.ITJ.number1 tal.str_parser run data get storage t_algorithm_lib:item_to_json temp.HideFlags_list[-6]
execute unless score #tal.o.ITJ.number1 tal.str_parser matches 1 if data storage t_algorithm_lib:item_to_json temp.item.tag.display.color run data modify storage t_algorithm_lib:item_to_json temp.string_list append value '[{"text":"\\n"},{"translate":"item.dyed","color":"#A8A8A8"}]'
##Lore
function t_algorithm_lib:others/json_text/item_content_to_json_text/lore

##是否物品显示个数
# scoreboard players set #tal.o.ITJ.show_count tal.str_parser 1
...
execute store result score #tal.o.ITJ.number1 tal.str_parser run data get storage t_algorithm_lib:item_to_json temp.HideFlags_list[-2]
execute unless score #tal.o.ITJ.number1 tal.str_parser matches 1 run function t_algorithm_lib:others/json_text/item_content_to_json_text/attribute_modifiers/start
...
##CanDestroy能破坏
execute store result score #tal.o.ITJ.number1 tal.str_parser run data get storage t_algorithm_lib:item_to_json temp.HideFlags_list[-4]
execute unless score #tal.o.ITJ.number1 tal.str_parser matches 1 run function t_algorithm_lib:others/json_text/item_content_to_json_text/can_destroy/start
##CanPlaceOn能放置在
execute store result score #tal.o.ITJ.number1 tal.str_parser run data get storage t_algorithm_lib:item_to_json temp.HideFlags_list[-5]
execute unless score #tal.o.ITJ.number1 tal.str_parser matches 1 run function t_algorithm_lib:others/json_text/item_content_to_json_text/can_place_on/start
...
##无法破坏
execute store result score #tal.o.ITJ.number1 tal.str_parser run data get storage t_algorithm_lib:item_to_json temp.HideFlags_list[-4]
execute unless score #tal.o.ITJ.number1 tal.str_parser matches 1 if data storage t_algorithm_lib:item_to_json temp.item.tag{Unbreakable:1b} run function t_algorithm_lib:others/json_text/item_content_to_json_text/unbreakable
execute unless score #tal.o.ITJ.number1 tal.str_parser matches 1 if data storage t_algorithm_lib:item_to_json temp.item.tag{Unbreakable:1} run function t_algorithm_lib:others/json_text/item_content_to_json_text/unbreakable
...
##生成物品
#是否显示个数
execute as @e[type=area_effect_cloud,tag=tal.o.ITJ.temp,distance=..2] run scoreboard players operation @s tal.str_parser = #tal.o.ITJ.show_count tal.str_parser
