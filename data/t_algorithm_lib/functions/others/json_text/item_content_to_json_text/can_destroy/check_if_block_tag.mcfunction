...
execute if score #tal.o.ITJ.IsFail tal.str_parser matches 0 run function t_algorithm_lib:others/json_text/item_content_to_json_text/can_destroy/add_block_tag_to_list
execute if score #tal.o.ITJ.IsFail tal.str_parser matches 0 run data modify storage t_algorithm_lib:item_to_json temp.item_CanDestroy.list set from storage t_algorithm_lib:item_to_json temp.tag.blocks
...
execute if score #tal.o.ITJ.list.success tal.str_parser matches 0 if score #tal.o.ITJ.list.count2 tal.str_parser < #tal.o.ITJ.list.count tal.str_parser run function t_algorithm_lib:others/json_text/item_content_to_json_text/can_destroy/check_if_block_tag