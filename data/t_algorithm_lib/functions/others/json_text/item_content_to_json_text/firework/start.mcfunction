...
##Explosions
execute if data storage t_algorithm_lib:item_to_json temp.item{id:"minecraft:firework_rocket"} store result score #tal.o.ITJ.list.count tal.str_parser run data get storage t_algorithm_lib:item_to_json temp.item.tag.Fireworks.Explosions
...
execute if data storage t_algorithm_lib:item_to_json temp.item{id:"minecraft:firework_rocket"} if score #tal.o.ITJ.list.count tal.str_parser matches 1.. run function t_algorithm_lib:others/json_text/item_content_to_json_text/firework/rocket_loop

execute if data storage t_algorithm_lib:item_to_json temp.item{id:"minecraft:firework_star"} store result score #tal.o.ITJ.list.count tal.str_parser run data get storage t_algorithm_lib:item_to_json temp.item.tag.Explosion
data modify storage t_algorithm_lib:item_to_json temp.item_Explosions.list set value []
...
execute if data storage t_algorithm_lib:item_to_json temp.item{id:"minecraft:firework_star"} if score #tal.o.ITJ.list.count tal.str_parser matches 1.. run function t_algorithm_lib:others/json_text/item_content_to_json_text/firework/rocket_loop