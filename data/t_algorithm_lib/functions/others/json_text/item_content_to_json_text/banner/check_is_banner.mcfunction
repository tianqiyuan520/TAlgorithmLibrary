...
execute if entity @e[tag=tal.o.ITJ.check_is_banner,distance=..1,sort=nearest,predicate=t_algorithm_lib:check_is_banner] if score #tal.o.ITJ.list.count tal.input matches 1.. positioned -29999999 3 20228209 run function t_algorithm_lib:others/json_text/item_content_to_json_text/banner/loop
