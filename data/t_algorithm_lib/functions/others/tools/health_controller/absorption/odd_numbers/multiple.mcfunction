...
scoreboard players add #tal.health_controller.Absorption_check tal.str_parser 9
#获取等级
...
# summon area_effect_cloud ~ ~ ~ {Tags:["tal.health_controller.hurtObj.area_effect_cloud_Absorption"],Radius:0.2f,Duration:10,Effects:[{Id:7,Amplifier:0,Duration:20}],Particle:underwater,WaitTime:10}

tag @s add tal.health_controller.AbsorptionAmount.odd
schedule function t_algorithm_lib:others/tools/health_controller/absorption/odd_numbers/-3 10t append
tag @s add tal.health_controller.AbsorptionAmount.end
