##等于0，复查
scoreboard players set #tal.maths.integrate.check_power tal.input 1
...
execute if score #tal.maths.integrate.main.count tal.input matches 0 if data storage t_algorithm_lib:maths integrate.main.new_data[0][0][0] run function t_algorithm_lib:maths/integrate/indefinite_integral/main/der/per/1/check1
