...
execute store result score #tal.maths.integrate.list_count tal.str_parser run data get storage t_algorithm_lib:maths integrate.temp.list
...
execute unless score #tal.maths.integrate.list_count tal.str_parser = #tal.maths.integrate.list_count2 tal.str_parser run data modify storage t_algorithm_lib:maths integrate.temp.list append from storage t_algorithm_lib:maths integrate.temp.separation[0]
#存储 是否为数字
execute unless score #tal.maths.integrate.list_count tal.str_parser = #tal.maths.integrate.list_count2 tal.str_parser run scoreboard players set #tal.maths.integrate.is_num tal.str_parser 1

#如果不是数字
execute if score #tal.maths.integrate.list_count tal.str_parser = #tal.maths.integrate.list_count2 tal.str_parser if score #tal.maths.integrate.is_num tal.str_parser matches 1 run function t_algorithm_lib:maths/integrate/indefinite_integral/separate/get_num
execute if score #tal.maths.integrate.list_count tal.str_parser = #tal.maths.integrate.list_count2 tal.str_parser if score #tal.maths.integrate.is_num tal.str_parser matches 1 run scoreboard players set #tal.maths.integrate.is_num tal.str_parser 0

execute if score #tal.maths.integrate.list_count tal.str_parser = #tal.maths.integrate.list_count2 tal.str_parser run data modify storage t_algorithm_lib:maths integrate.temp.n set from storage t_algorithm_lib:maths integrate.temp.separation[0]
execute if score #tal.maths.integrate.list_count tal.str_parser = #tal.maths.integrate.list_count2 tal.str_parser run function t_algorithm_lib:maths/integrate/indefinite_integral/separate/check_special_func
execute if score #tal.maths.integrate.list_count tal.str_parser = #tal.maths.integrate.list_count2 tal.str_parser unless score #tal.maths.integrate.is_down_tier tal.str_parser matches 1 run function t_algorithm_lib:maths/integrate/indefinite_integral/separate/end
...
execute if score #tal.maths.integrate.list_count tal.str_parser matches 0 if score #tal.maths.integrate.is_num tal.str_parser matches 1 run function t_algorithm_lib:maths/integrate/indefinite_integral/separate/get_num
