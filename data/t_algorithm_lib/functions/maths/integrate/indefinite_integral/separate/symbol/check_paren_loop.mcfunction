...
execute if score #tal.maths.integrate.success tal.input matches 1 run scoreboard players add #tal.maths.integrate.paren_ tal.input 1
...
execute if score #tal.maths.integrate.paren_ tal.input matches 1.. if score #tal.maths.integrate.success2 tal.input matches 1 run scoreboard players remove #tal.maths.integrate.paren_ tal.input 1
...
execute unless score #tal.maths.integrate.index tal.input matches ..0 run function t_algorithm_lib:maths/integrate/indefinite_integral/separate/symbol/check_paren_loop