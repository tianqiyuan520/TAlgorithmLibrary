...
data modify storage t_algorithm_lib:maths integrate.temp.list_check.char set from storage t_algorithm_lib:maths integrate.temp.data[0][0]
execute if score #tal.maths.integrate.check_power tal.str_parser matches 1 if data storage t_algorithm_lib:maths integrate.temp.list_check{char:'^'} run scoreboard players set #tal.maths.integrate.success tal.str_parser 1
