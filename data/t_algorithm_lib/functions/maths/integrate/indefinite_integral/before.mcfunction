...
data modify storage t_algorithm_lib:maths integrate.preparation_chars set from storage t_algorithm_lib:string_parser preparation_chars
data modify storage t_algorithm_lib:maths integrate.parameter set from storage t_algorithm_lib:string_parser io.parameter
...
data modify storage t_algorithm_lib:string_parser io.command set value '/function t_algorithm_lib:maths/integrate/indefinite_integral/wait_for_p'
