...
execute if score #tal.maths.integrate.success tal.str_parser matches 1 run data modify storage t_algorithm_lib:maths integrate.is_der append value 0
execute if score #tal.maths.integrate.success tal.str_parser matches 0 run data modify storage t_algorithm_lib:maths integrate.is_der append value 1
...
execute unless score #tal.maths.integrate.index tal.str_parser matches ..0 run function t_algorithm_lib:maths/integrate/indefinite_integral/get_first