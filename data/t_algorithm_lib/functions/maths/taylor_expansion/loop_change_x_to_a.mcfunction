...
execute store result score #tal.maths.taylor_expansion.list_count tal.input run data get storage t_algorithm_lib:maths taylor_expansion.input
execute if score #tal.maths.taylor_expansion.list_count tal.input matches 1.. run function t_algorithm_lib:maths/taylor_expansion/loop_change_x_to_a