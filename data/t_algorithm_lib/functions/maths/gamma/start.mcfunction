...
execute store result score #tal.maths.gamma.num1 tal.str_parser run data get storage t_algorithm_lib:maths gamma.input.num 10000
execute store result storage t_algorithm_lib:maths stirling.input.num double 0.0001 run scoreboard players remove #tal.maths.gamma.num1 tal.str_parser 10000
