...
execute unless score #tal.maths.polynomial.index tal.str_parser matches ..0 run function t_algorithm_lib:maths/polynomial/simplify/separate/symbol/check_paren_loop