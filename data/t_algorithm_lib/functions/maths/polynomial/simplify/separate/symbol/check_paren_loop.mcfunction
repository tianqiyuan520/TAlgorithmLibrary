...
execute if score #tal.maths.polynomial.success tal.input matches 1 run scoreboard players add #tal.maths.polynomial.paren_ tal.input 1
...
execute if score #tal.maths.polynomial.paren_ tal.input matches 1.. if score #tal.maths.polynomial.success2 tal.input matches 1 run scoreboard players remove #tal.maths.polynomial.paren_ tal.input 1
...
scoreboard players remove #tal.maths.polynomial.index tal.input 1
execute unless score #tal.maths.polynomial.index tal.input matches ..0 run function t_algorithm_lib:maths/polynomial/simplify/separate/symbol/check_paren_loop