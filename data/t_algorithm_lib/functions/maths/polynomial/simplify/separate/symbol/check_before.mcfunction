...
execute if score #tal.maths.polynomial.fail tal.input matches 0 run function t_algorithm_lib:maths/polynomial/simplify/separate/symbol/check_paren_loop
#不对等
...
execute if score #tal.maths.polynomial.success3 tal.input matches 1.. if score #tal.maths.polynomial.fail tal.input matches 0 run function t_algorithm_lib:maths/polynomial/simplify/separate/symbol/check_before