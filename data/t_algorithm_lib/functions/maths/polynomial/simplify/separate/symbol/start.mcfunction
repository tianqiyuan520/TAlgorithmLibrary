##提取 连接的符号 括号外
#是否检测 ^ 符号
# scoreboard players set #tal.maths.polynomial.check_power tal.input 0
#是否只检测 + - 符号
# scoreboard players set #tal.maths.polynomial.only tal.input 0
#分离次数
# scoreboard players set #tal.maths.polynomial.time tal.input 999999
scoreboard players set #tal.maths.polynomial.time_ tal.input 0
