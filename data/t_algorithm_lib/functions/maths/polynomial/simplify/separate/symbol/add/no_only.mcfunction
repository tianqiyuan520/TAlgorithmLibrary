...
data modify storage t_algorithm_lib:maths polynomial.temp.list_check.char set from storage t_algorithm_lib:maths polynomial.temp.data[0][0]
execute if score #tal.maths.polynomial.check_power tal.input matches 1 if data storage t_algorithm_lib:maths polynomial.temp.list_check{char:'^'} run scoreboard players set #tal.maths.polynomial.success tal.input 1
