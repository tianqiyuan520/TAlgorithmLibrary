...
execute store result score #tal.maths.polynomial.list_count tal.str_parser run data get storage t_algorithm_lib:maths polynomial.temp.data2[-1]
execute if score #tal.maths.polynomial.list_count tal.str_parser matches 1 run function t_algorithm_lib:maths/polynomial/simplify/general/symbol/add/add_power
