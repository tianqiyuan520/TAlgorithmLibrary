...
execute unless score #tal.maths.polynomial.index tal.input matches ..0 run function t_algorithm_lib:maths/polynomial/simplify/general/symbol/check_paren_loop