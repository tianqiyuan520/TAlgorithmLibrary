...
execute if score #tal.maths.polynomial.fail tal.str_parser matches 0 run function t_algorithm_lib:maths/polynomial/simplify/general/symbol/check_paren_loop
#不对等
...
execute if score #tal.maths.polynomial.success3 tal.str_parser matches 1.. if score #tal.maths.polynomial.fail tal.str_parser matches 0 run function t_algorithm_lib:maths/polynomial/simplify/general/symbol/check_before