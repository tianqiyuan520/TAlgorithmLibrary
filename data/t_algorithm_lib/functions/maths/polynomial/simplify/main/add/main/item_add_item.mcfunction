...
scoreboard players add #tal.maths.polynomial.is_simple tal.str_parser 1
#如果没有共同
# execute if score #tal.maths.polynomial.temp.check_end tal.str_parser matches 0 run function t_algorithm_lib:maths/polynomial/simplify/main/add/main/no_matches
...
# execute if score #tal.maths.polynomial.is_simple tal.str_parser matches 2.. run function t_algorithm_lib:maths/polynomial/simplify/main/add/main/item_add_rsult_and_gcd2
