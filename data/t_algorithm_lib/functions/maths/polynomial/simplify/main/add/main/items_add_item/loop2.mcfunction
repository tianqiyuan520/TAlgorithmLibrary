...
execute store success score #tal.str.polynomial.check tal.str_parser run data modify storage t_algorithm_lib:maths polynomial.temp.check set from storage t_algorithm_lib:maths polynomial.add.temp.list[0][0]
...
#轮换
scoreboard players remove #tal.maths.polynomial.list_count2 tal.str_parser 1
...
execute if score #tal.maths.polynomial.list_count2 tal.str_parser matches 1.. run function t_algorithm_lib:maths/polynomial/simplify/main/add/main/item/loop2