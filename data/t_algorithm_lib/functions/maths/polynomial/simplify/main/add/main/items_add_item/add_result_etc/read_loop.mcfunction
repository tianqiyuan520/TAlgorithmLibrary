...
execute if score #tal.maths.polynomial.list_count tal.input matches 1.. run data modify storage t_algorithm_lib:maths polynomial.temp.list_[0] append value ['*']
