...
execute store success score #tal.str.polynomial.check tal.input run data modify storage t_algorithm_lib:maths polynomial.temp.check set from storage t_algorithm_lib:maths polynomial.add.list[0][0]
...
#轮换
scoreboard players remove #tal.maths.polynomial.time tal.input 1
...
execute if score #tal.maths.polynomial.time tal.input matches 1.. run function t_algorithm_lib:maths/polynomial/simplify/main/add/main/item/loop2