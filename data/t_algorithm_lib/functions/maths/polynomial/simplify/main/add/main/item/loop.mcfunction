...
#如果有重复，则添加到gcd函数中
execute if score #tal.maths.polynomial.temp.is_gcd tal.str_parser matches 1 run data modify storage t_algorithm_lib:maths polynomial.add.temp.gcd append from storage t_algorithm_lib:maths polynomial.add.temp.list
...
#如果无重复，则添加到result函数中
execute if score #tal.maths.polynomial.temp.is_gcd tal.str_parser matches 0 run data modify storage t_algorithm_lib:maths polynomial.add.temp.result append from storage t_algorithm_lib:maths polynomial.add.temp.list
