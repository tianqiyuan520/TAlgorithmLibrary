##判断指针，替换数据
execute if score #tal.maths.polynomial.main.index_all_ tal.input = #tal.maths.polynomial.main.index_last tal.input run data modify storage t_algorithm_lib:maths polynomial.main.main_tree[-2][0][0] set from storage t_algorithm_lib:maths polynomial.main.main_tree[-1][0]
##判断类型替换数据
##polynomial.main.main_tree[-1][0]是0,类型为mul则 源数据=0 ,源数据溯回=1 
##polynomial.main.main_tree[-1][0]是1,类型为mul则 源数据移除
scoreboard players set #tal.maths.polynomial.main.is_zero tal.input 0
...
# execute if data storage t_algorithm_lib:maths polynomial.temp.list_check{char:[[[0]]]} if score #tal.maths.polynomial.main.index_all_ tal.input = #tal.maths.polynomial.main.index_last tal.input unless score #tal.maths.polynomial.main.index_last tal.input matches 0 run function t_algorithm_lib:maths/polynomial/simplify/main/tree/change_last_data/add_0
# execute if data storage t_algorithm_lib:maths polynomial.temp.list_check{char:[[0]]} if score #tal.maths.polynomial.main.index_all_ tal.input = #tal.maths.polynomial.main.index_last tal.input unless score #tal.maths.polynomial.main.index_last tal.input matches 0 run function t_algorithm_lib:maths/polynomial/simplify/main/tree/change_last_data/add_0
...
scoreboard players add #tal.maths.polynomial.main.index_all_ tal.input 1
scoreboard players remove #tal.maths.polynomial.main.index_all tal.input 1
execute if score #tal.maths.polynomial.main.index_all tal.input matches 1.. run function t_algorithm_lib:maths/polynomial/simplify/main/tree/change_last_data
