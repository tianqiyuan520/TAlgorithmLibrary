...
execute store result score #tal.maths.polynomial.num tal.str_parser run data get storage t_algorithm_lib:maths polynomial.main.this_data
...
##触发 二号连接符
execute if score #tal.maths.polynomial.temp.symbol2 tal.str_parser matches 1 run data modify storage t_algorithm_lib:maths polynomial.main.main_tree[-1][0] set from storage t_algorithm_lib:maths polynomial.main.this_data[0]
