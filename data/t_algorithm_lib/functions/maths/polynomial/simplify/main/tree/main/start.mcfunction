...
scoreboard players operation #tal.array.get_element_by_index.index tal.str_parser = #tal.maths.polynomial.main.index tal.str_parser
...
##判断该数据是否为 + - * / ^
scoreboard players set #tal.maths.polynomial.temp.symbol tal.str_parser 0
...
execute if data storage t_algorithm_lib:maths polynomial.temp.list_check{char:"+"} run scoreboard players set #tal.maths.polynomial.temp.symbol tal.str_parser 1
execute if data storage t_algorithm_lib:maths polynomial.temp.list_check{char:"-"} run scoreboard players set #tal.maths.polynomial.temp.symbol tal.str_parser 1
execute if data storage t_algorithm_lib:maths polynomial.temp.list_check{char:"*"} run scoreboard players set #tal.maths.polynomial.temp.symbol tal.str_parser 1
execute if data storage t_algorithm_lib:maths polynomial.temp.list_check{char:"/"} run scoreboard players set #tal.maths.polynomial.temp.symbol tal.str_parser 1
execute if data storage t_algorithm_lib:maths polynomial.temp.list_check{char:"^"} run scoreboard players set #tal.maths.polynomial.temp.symbol tal.str_parser 1
...
##非 符号，则判断 该如何新建树 
execute if score #tal.maths.polynomial.temp.symbol tal.str_parser matches 0 run function t_algorithm_lib:maths/polynomial/simplify/main/tree/main/add_tree_branches/start