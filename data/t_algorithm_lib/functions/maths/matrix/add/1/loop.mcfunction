...
execute store result storage t_algorithm_lib:maths matrix.add.result[-1] double 0.01 run scoreboard players get #tal.maths.matrix.num tal.str_parser
...
execute if score #tal.maths.matrix.list_count tal.str_parser matches 1.. run function t_algorithm_lib:maths/matrix/add/1/loop
