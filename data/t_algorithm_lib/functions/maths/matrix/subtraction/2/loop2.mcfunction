...
execute store result storage t_algorithm_lib:maths matrix.subtraction.result[-1][0] double 0.01 run scoreboard players get #tal.maths.matrix.num tal.input
...
execute if score #tal.maths.matrix.list_count tal.input matches 1.. run function t_algorithm_lib:maths/matrix/subtraction/2/loop2
