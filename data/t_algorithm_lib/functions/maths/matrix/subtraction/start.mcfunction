...
data modify storage t_algorithm_lib:maths matrix.subtraction.result set value []
##判断维度相不相同
...
scoreboard players set #tal.maths.matrix.subtraction.fail tal.str_parser 0
##判断一维/二维
