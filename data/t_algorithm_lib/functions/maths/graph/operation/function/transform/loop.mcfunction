...
execute store result score #tal.maths.graph.num tal.input run data get storage t_algorithm_lib:maths graph.operation.function.transform.input
execute if score #tal.maths.graph.num tal.input matches 1.. run schedule function t_algorithm_lib:maths/graph/operation/function/transform/loop 1t replace
execute if score #tal.maths.graph.num tal.input matches 0 run schedule clear t_algorithm_lib:maths/graph/operation/function/transform/loop
execute if score #tal.maths.graph.num tal.input matches 0 run function t_algorithm_lib:maths/graph/operation/function/transform/end
