...
##[自定义输入]是否计算tan()
# scoreboard players set #tal.num.trigonometric_functions.tan tal.str_parser 0
##返回结果
...
execute if score #tal.num.trigonometric_functions.tan tal.str_parser matches 1 run function t_algorithm_lib:maths/trigonometric_functions/sin_cos_tan/tan
