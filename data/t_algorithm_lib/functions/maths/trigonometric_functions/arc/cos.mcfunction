...
execute store result score #tal.maths.trigonometric_functions.num tal.input run data get storage t_algorithm_lib:maths trigonometric_functions.input 1000
#cal
scoreboard players set #1000000 tal.input 1000000
...
scoreboard players operation #1000000 tal.input -= #tal.maths.trigonometric_functions.num tal.input

scoreboard players operation #tal.maths.trigonometric_functions.num3 tal.input = #1000000 tal.input
