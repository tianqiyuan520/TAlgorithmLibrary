##等于0，复查
scoreboard players set #tal.maths.derivation.check_power tal.input 1
...
execute if score #tal.maths.derivation.main.count tal.input matches 0 if data storage t_algorithm_lib:maths auto_derivation.main.new_data[0][0][0] run function t_algorithm_lib:maths/auto_derivation/main/der/per/1/check1
