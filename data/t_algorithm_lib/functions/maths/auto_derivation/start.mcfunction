...
execute unless score #tal.maths.derivation.taylor tal.str_parser matches 1 run function t_algorithm_lib:maths/auto_derivation/separate/start
execute if score #tal.maths.derivation.taylor tal.str_parser matches 1 run data modify storage t_algorithm_lib:maths auto_derivation.separation set from storage t_algorithm_lib:maths auto_derivation.input
scoreboard players set #tal.maths.derivation.taylor tal.str_parser 0
...
##分离符号
scoreboard players set #tal.maths.derivation.only tal.str_parser 1
...
scoreboard players set #tal.maths.derivation.main.end tal.str_parser 0

##开始循环
scoreboard players set #tal.maths.derivation.main.time tal.str_parser 500
...
execute if score #tal.maths.derivation.main.end tal.str_parser matches 1 run function t_algorithm_lib:maths/auto_derivation/end