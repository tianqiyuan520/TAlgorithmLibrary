...
execute store result score #tal.maths.statistics_utils.num tal.str_parser run data get storage t_algorithm_lib:maths statistics_utils.var.list
...
execute store result storage t_algorithm_lib:maths statistics_utils.average.result double 0.0001 run scoreboard players get #tal.maths.statistics_utils.result tal.str_parser
