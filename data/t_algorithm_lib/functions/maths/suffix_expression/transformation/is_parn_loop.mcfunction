...
execute unless data storage t_algorithm_lib:maths suffix_expression.temp.list_check{char:'('} if score #tal.maths.suffix_expression.list_count tal.input matches 1.. run function t_algorithm_lib:maths/suffix_expression/transformation/is_parn_loop