...
##
##数字入栈
execute if score #tal.maths.suffix_expression.symbol tal.str_parser matches 0 run data modify storage t_algorithm_lib:maths suffix_expression.transformation2.s1 append value []
execute if score #tal.maths.suffix_expression.symbol tal.str_parser matches 0 run data modify storage t_algorithm_lib:maths suffix_expression.transformation2.s1[-1] append from storage t_algorithm_lib:maths suffix_expression.transformation2.s3[0]

##符号
execute unless score #tal.maths.suffix_expression.symbol tal.str_parser matches 0 run function t_algorithm_lib:maths/suffix_expression/transformation2/is_symbol
...
execute if score #tal.maths.suffix_expression.list_count tal.str_parser matches 0 run function t_algorithm_lib:maths/suffix_expression/transformation2/end
