...
execute unless data storage t_algorithm_lib:maths calculator.temp.list_check{char:'('} if score #tal.maths.calculator.list_count tal.str_parser matches 1.. run function t_algorithm_lib:maths/calculator/transformation/is_parn_loop