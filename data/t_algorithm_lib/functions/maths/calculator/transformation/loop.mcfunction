...
##
##数字入栈
execute if score #tal.maths.calculator.symbol tal.input matches 0 if score #tal.maths.calculator.symbol_ tal.input matches 0 run data modify storage t_algorithm_lib:maths calculator.transformation.s1 append from storage t_algorithm_lib:maths calculator.transformation.s3[0]
...
execute unless data storage t_algorithm_lib:maths calculator.temp.list_check{char:')'} unless score #tal.maths.calculator.symbol tal.input matches 0 run function t_algorithm_lib:maths/calculator/transformation/is_symbol
