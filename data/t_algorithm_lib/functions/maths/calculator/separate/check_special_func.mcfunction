...
scoreboard players set #tal.maths.calculator.remove_1 tal.input 0
...
execute if score #tal.maths.calculator.fail tal.input matches 0 run scoreboard players set #tal.maths.calculator.remove_1 tal.input 1
...
execute unless score #tal.maths.calculator.success2 tal.input matches 1 run scoreboard players set #tal.maths.calculator.fail tal.input 1
execute unless score #tal.maths.calculator.success3 tal.input matches 1 run scoreboard players set #tal.maths.calculator.fail tal.input 1
execute if score #tal.maths.calculator.fail tal.input matches 0 run scoreboard players set #tal.maths.calculator.remove_2 tal.input 1
...
data modify storage t_algorithm_lib:maths calculator.temp.list_check.char set from storage t_algorithm_lib:maths calculator.temp.separation[0]
execute if data storage t_algorithm_lib:maths calculator.temp.list_check{char:"a"} run scoreboard players set #tal.maths.calculator.success tal.input 1
data modify storage t_algorithm_lib:maths calculator.temp.list_check.char set from storage t_algorithm_lib:maths calculator.temp.separation[1]
execute if data storage t_algorithm_lib:maths calculator.temp.list_check{char:"b"} run scoreboard players set #tal.maths.calculator.success2 tal.input 1
data modify storage t_algorithm_lib:maths calculator.temp.list_check.char set from storage t_algorithm_lib:maths calculator.temp.separation[2]
execute if data storage t_algorithm_lib:maths calculator.temp.list_check{char:"("} run scoreboard players set #tal.maths.calculator.success3 tal.input 1
data modify storage t_algorithm_lib:maths calculator.temp.list_check.char set from storage t_algorithm_lib:maths calculator.temp.separation[3]
...
execute unless score #tal.maths.calculator.success3 tal.input matches 1 run scoreboard players set #tal.maths.calculator.fail tal.input 1
execute if score #tal.maths.calculator.fail tal.input matches 0 run scoreboard players set #tal.maths.calculator.remove_2 tal.input 1
execute if score #tal.maths.calculator.fail tal.input matches 0 run data modify storage t_algorithm_lib:maths calculator.temp.n set value 'ab('




execute if score #tal.maths.calculator.remove_1 tal.input matches 1 run data remove storage t_algorithm_lib:maths calculator.temp.separation[0]
execute if score #tal.maths.calculator.remove_1 tal.input matches 1 run data remove storage t_algorithm_lib:maths calculator.temp.separation[0]
execute if score #tal.maths.calculator.remove_1 tal.input matches 1 run data remove storage t_algorithm_lib:maths calculator.temp.separation[0]

execute if score #tal.maths.calculator.remove_2 tal.input matches 1 run data remove storage t_algorithm_lib:maths calculator.temp.separation[0]
execute if score #tal.maths.calculator.remove_2 tal.input matches 1 run data remove storage t_algorithm_lib:maths calculator.temp.separation[0]