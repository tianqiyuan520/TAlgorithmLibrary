...
execute if score #tal.maths.calculator.success tal.str_parser matches 1 run scoreboard players add #tal.maths.calculator.paren_ tal.str_parser 1
...
execute if score #tal.maths.calculator.paren_ tal.str_parser matches 1.. if score #tal.maths.calculator.success2 tal.str_parser matches 1 run scoreboard players remove #tal.maths.calculator.paren_ tal.str_parser 1
...
scoreboard players remove #tal.maths.calculator.index tal.str_parser 1
execute unless score #tal.maths.calculator.index tal.str_parser matches ..0 run function t_algorithm_lib:maths/calculator/separate/symbol/check_paren_loop