...
execute store result score #tal.maths.calculator.list_count tal.input run data get storage t_algorithm_lib:maths calculator.temp.list
...
execute unless score #tal.maths.calculator.list_count tal.input = #tal.maths.calculator.list_count2 tal.input run data modify storage t_algorithm_lib:maths calculator.temp.list append from storage t_algorithm_lib:maths calculator.temp.separation[0]
#存储 是否为数字
execute unless score #tal.maths.calculator.list_count tal.input = #tal.maths.calculator.list_count2 tal.input run scoreboard players set #tal.maths.calculator.is_num tal.input 1

#如果不是数字
execute if score #tal.maths.calculator.list_count tal.input = #tal.maths.calculator.list_count2 tal.input if score #tal.maths.calculator.is_num tal.input matches 1 run function t_algorithm_lib:maths/calculator/separate/get_num
execute if score #tal.maths.calculator.list_count tal.input = #tal.maths.calculator.list_count2 tal.input if score #tal.maths.calculator.is_num tal.input matches 1 run scoreboard players set #tal.maths.calculator.is_num tal.input 0

execute if score #tal.maths.calculator.list_count tal.input = #tal.maths.calculator.list_count2 tal.input run data modify storage t_algorithm_lib:maths calculator.temp.n set from storage t_algorithm_lib:maths calculator.temp.separation[0]
execute if score #tal.maths.calculator.list_count tal.input = #tal.maths.calculator.list_count2 tal.input run function t_algorithm_lib:maths/calculator/separate/check_special_func
execute if score #tal.maths.calculator.list_count tal.input = #tal.maths.calculator.list_count2 tal.input unless score #tal.maths.calculator.is_down_tier tal.input matches 1 run function t_algorithm_lib:maths/calculator/separate/end
...
execute if score #tal.maths.calculator.list_count tal.input matches 0 if score #tal.maths.calculator.is_num tal.input matches 1 run function t_algorithm_lib:maths/calculator/separate/get_num


execute if score #tal.maths.calculator.list_count tal.input matches 1.. run function t_algorithm_lib:maths/calculator/separate/loop