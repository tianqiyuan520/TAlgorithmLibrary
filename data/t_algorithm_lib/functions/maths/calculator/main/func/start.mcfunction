...
data modify storage t_algorithm_lib:maths calculator.main.stack[-1][1][-1] set value []
...
# tellraw @a ["返回的值 ",{"nbt":"calculator.main.stack[-1][2]","storage":"t_algorithm_lib:maths"}]
