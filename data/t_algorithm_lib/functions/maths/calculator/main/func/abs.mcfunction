##绝对值
data modify storage t_algorithm_lib:array double_to_array.num set from storage t_algorithm_lib:maths calculator.main.stack[-1][2][0][0]
scoreboard players set #tal.array.double_to_array.symbol tal.input 0
