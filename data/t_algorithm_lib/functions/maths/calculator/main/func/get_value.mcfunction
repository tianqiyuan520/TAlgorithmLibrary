...
execute if data storage t_algorithm_lib:maths calculator.temp{char:["ab("]} run function t_algorithm_lib:maths/calculator/main/func/ab/ab
...
data modify storage t_algorithm_lib:maths calculator.main.stack[-1][1][-1][-1] append from storage t_algorithm_lib:maths calculator.main.fuc_value