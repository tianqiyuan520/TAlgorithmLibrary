...
##数字入栈
execute if score #tal.maths.calculator.list_count2 tal.input matches 1 if score #tal.maths.calculator.symbol tal.input matches 0 run data modify storage t_algorithm_lib:maths calculator.main.stack[-1][1] append from storage t_algorithm_lib:maths calculator.main.stack[-1][0][0]
