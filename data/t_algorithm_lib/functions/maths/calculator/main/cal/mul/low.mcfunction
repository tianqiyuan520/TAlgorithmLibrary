...
execute store result storage t_algorithm_lib:maths calculator.main.stack[-1][1][-1][-2][] double 0.000001 run scoreboard players operation #tal.maths.calculator.num tal.input *= #tal.maths.calculator.num2 tal.input
