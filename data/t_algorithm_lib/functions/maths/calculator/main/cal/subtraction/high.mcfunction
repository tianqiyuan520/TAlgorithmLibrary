...
data modify storage t_algorithm_lib:array double_to_array.num set from storage t_algorithm_lib:maths calculator.main.stack[-1][1][-1][-2][0]
...
#
data modify storage t_algorithm_lib:array double_to_array.num set from storage t_algorithm_lib:maths calculator.main.stack[-1][1][-1][-1][0]
function t_algorithm_lib:array/double_to_array/start
...
data modify storage t_algorithm_lib:maths calculator.main.stack[-1][1][-1][-2][] set from storage t_algorithm_lib:array double_array_to_double.result