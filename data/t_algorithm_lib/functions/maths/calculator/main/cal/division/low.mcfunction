##除法
execute store result score #tal.maths.calculator.num_ tal.input run data get storage t_algorithm_lib:maths calculator.main.stack[-1][1][-1][-2][0] 1000
...
execute store result storage t_algorithm_lib:maths calculator.main.stack[-1][1][-1][-2][] double 0.001 run scoreboard players get #tal.maths.calculator.num tal.input
