...
execute unless data storage t_algorithm_lib:array double_array_to_double{char:"-"} unless data storage t_algorithm_lib:array double_array_to_double{char:"+"} if score #tal.array.DAToDouble.num1 tal.input matches 0 run data modify storage t_algorithm_lib:array double_array_to_double.num1 append from storage t_algorithm_lib:array double_array_to_double.temp[0][0]
...
execute if score #tal.array.DAToDouble.list_count1 tal.input matches 1.. if score #tal.array.DAToDouble.num1 tal.input matches 0 run function t_algorithm_lib:array/double_array_to_double/get_num1
