...
execute if score #tal.array.DAToDouble.num1 tal.str_parser matches 0 run data modify storage t_algorithm_lib:array double_array_to_double.num1 append from storage t_algorithm_lib:array double_array_to_double.temp[0][0]
