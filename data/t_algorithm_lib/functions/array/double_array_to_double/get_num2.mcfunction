...
execute if score #tal.array.DAToDouble.num1 tal.str_parser matches 1 run data modify storage t_algorithm_lib:array double_array_to_double.num2 append from storage t_algorithm_lib:array double_array_to_double.temp[0][0]
...
execute if score #tal.array.DAToDouble.list_count1 tal.str_parser matches 1.. run function t_algorithm_lib:array/double_array_to_double/get_num2