...
execute if score #tal.array.DAToDouble.list_count3 tal.input matches 1.. if score #tal.array.DAToDouble.list_count1 tal.input matches 0 run function t_algorithm_lib:array/double_array_to_double/loop/integer/tp_7

execute if score #tal.array.DAToDouble.list_count3 tal.input matches 1.. if score #tal.array.DAToDouble.negative tal.input matches 1 if score #tal.array.DAToDouble.tier tal.input matches 5 if score #tal.array.DAToDouble.list_count1 tal.input matches 1.. positioned ~ ~100000 ~ run function t_algorithm_lib:array/double_array_to_double/loop/integer/tp_6
execute if score #tal.array.DAToDouble.list_count3 tal.input matches 1.. if score #tal.array.DAToDouble.negative tal.input matches -1 if score #tal.array.DAToDouble.tier tal.input matches 5 if score #tal.array.DAToDouble.list_count1 tal.input matches 1.. positioned ~ ~-100000 ~ run function t_algorithm_lib:array/double_array_to_double/loop/integer/tp_6
