...
# execute as @e[type=item,nbt={Item:{tag:{TAL:{num.hpc.check_pos:1b}}}}] run tellraw @a ["当前坐标： ",{"nbt":"Pos[1]","entity": "@s"}]
...
scoreboard players set #tal.array.DAToDouble.num2 tal.input 1