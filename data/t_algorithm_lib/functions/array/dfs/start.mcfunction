...
##指针
scoreboard players set #tal.array.dfs.index tal.str_parser 0
scoreboard players set #tal.array.dfs.deep tal.str_parser 0
...
scoreboard players set #tal.array.dfs.time tal.str_parser 10000
