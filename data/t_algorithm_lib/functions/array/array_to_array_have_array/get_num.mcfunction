...
execute store result score #tal.str.temp.list_count2 tal.input run data get storage t_algorithm_lib:array temp.list
...
execute unless score #tal.str.temp.list_count2 tal.input matches 0 run function t_algorithm_lib:array/array_to_array_have_array/check_tier
