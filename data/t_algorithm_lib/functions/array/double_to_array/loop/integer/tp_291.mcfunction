...
##判断角度
execute if score #tal.array.double_to_array.negative tal.str_parser matches 0 positioned ~ ~- ~ run function t_algorithm_lib:array/double_to_array/loop/integer/check_up_or_down
#负
execute if score #tal.array.double_to_array.negative tal.str_parser matches 1 positioned ~ ~ ~ run function t_algorithm_lib:array/double_to_array/loop/integer/check_up_or_down
...
execute if score #tal.array.double_to_array.is_more tal.str_parser matches 1 if score #tal.array.double_to_array.total tal.str_parser matches 1.. if score #tal.array.double_to_array.end tal.str_parser matches 0 run function t_algorithm_lib:array/double_to_array/loop/integer/tp_290
##迭代自己
scoreboard players set #tal.array.double_to_array.continue tal.str_parser 0
execute if score #tal.array.double_to_array.tier tal.str_parser matches 291 if score #tal.array.double_to_array.total tal.str_parser matches 1.. run scoreboard players set #tal.array.double_to_array.continue tal.str_parser 1
