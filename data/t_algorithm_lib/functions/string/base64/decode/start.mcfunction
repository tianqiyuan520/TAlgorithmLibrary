...
##对照ASCII表获取数据
scoreboard players set #tal.str.base64.decode.index tal.input 0
##遍历的数组
...
execute store result score #tal.str.base64.decode.list_count tal.input run data get storage t_algorithm_lib:string base64.decode.list1
execute if score #tal.str.base64.decode.list_count tal.input matches 1.. run function t_algorithm_lib:string/base64/decode/get_ascii/loop
