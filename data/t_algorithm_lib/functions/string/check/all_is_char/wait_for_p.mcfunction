...
execute store result score #tal.str.temp.list_count3 tal.input run data get storage t_algorithm_lib:array take_char.list
function t_algorithm_lib:array/take_str_char_for_array/start
execute store result score #tal.str.temp.list_count4 tal.input run data get storage t_algorithm_lib:array take_char.list2
