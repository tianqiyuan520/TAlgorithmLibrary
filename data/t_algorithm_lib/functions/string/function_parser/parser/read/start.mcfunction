##定位到x的位置
execute store result score #tal.str.temp.list_count tal.str_parser run data get storage t_algorithm_lib:string function_parser.separation
...
scoreboard players set #tal.str.fuc_p.len tal.str_parser 0
...
# execute if score #tal.str.temp.list_count tal.str_parser matches 1.. run function t_algorithm_lib:string/function_parser/parser/read/locate_x_loop
