...
execute if score #tal.str.temp.success tal.str_parser matches 1 if score #tal.str.temp.success2 tal.str_parser matches 1 if score #tal.str.temp.success3 tal.str_parser matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/power/c_num

data remove storage t_algorithm_lib:string function_parser.temp.list[0]

execute store result score #tal.str.temp.list_count tal.str_parser run data get storage t_algorithm_lib:string function_parser.temp.list
execute if score #tal.str.temp.list_count tal.str_parser matches 1.. run function t_algorithm_lib:string/function_parser/parser/start_from_x/power/start