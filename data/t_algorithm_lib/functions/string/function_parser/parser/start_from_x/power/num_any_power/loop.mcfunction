...
execute if score #tal.num.hpc.num3_pn tal.str_parser matches -1 run data modify storage t_algorithm_lib:string function_parser.power.num2 prepend value ["-"]

scoreboard players remove #tal.num.temp.power tal.str_parser 1
execute if score #tal.num.temp.power tal.str_parser matches 0..1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/power/num_any_power/end
