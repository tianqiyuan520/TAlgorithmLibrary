...
#返回值
execute if score #tal.num.temp.power tal.input matches 0 run data modify storage t_algorithm_lib:num temp.return set value 1.0
execute if score #tal.num.temp.power tal.input matches 1 run data modify storage t_algorithm_lib:num temp.return set from storage t_algorithm_lib:string function_parser.temp.list[0][0]
...
# execute store result storage t_algorithm_lib:num temp.return double 1.0 run scoreboard players get #tal.num.temp.num2 tal.input
