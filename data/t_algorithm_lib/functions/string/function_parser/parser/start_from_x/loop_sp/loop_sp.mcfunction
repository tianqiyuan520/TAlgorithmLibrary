...
execute store result score #tal.str.function_parser.list_count tal.input run data get storage t_algorithm_lib:string function_parser.temp.n3
execute if score #tal.str.function_parser.list_count tal.input matches 1.. run function t_algorithm_lib:string/function_parser/parser/start_from_x/loop_sp/loop_sp
