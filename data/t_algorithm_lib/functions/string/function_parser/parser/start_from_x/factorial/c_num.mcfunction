...
execute store result score #tal.str.temp.num tal.input run data get storage t_algorithm_lib:string function_parser.temp.list[0][0]

scoreboard players operation #tal.num.temp.num tal.input = #tal.str.temp.num tal.input
