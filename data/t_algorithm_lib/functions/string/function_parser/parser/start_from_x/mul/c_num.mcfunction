...
execute if score #tal.str.func_p.scale tal.input matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/mul/high_cal
execute if score #tal.str.func_p.scale tal.input matches 0 if score #tal.str.temp.is_division tal.input matches 0 run function t_algorithm_lib:string/function_parser/parser/start_from_x/mul/low_cal
execute if score #tal.str.func_p.scale tal.input matches 0 if score #tal.str.temp.is_division tal.input matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/mul/low_cal2
