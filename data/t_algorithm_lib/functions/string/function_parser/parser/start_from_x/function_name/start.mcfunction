...
data modify storage t_algorithm_lib:string function_parser.temp.list_check.char set from storage t_algorithm_lib:string function_parser.temp.list[0]
execute if data storage t_algorithm_lib:string function_parser.temp.list_check{char:["sin("]} run scoreboard players set #tal.str.temp.success tal.input 1
execute if data storage t_algorithm_lib:string function_parser.temp.list_check{char:["cos("]} run scoreboard players set #tal.str.temp.success tal.input 1
execute if data storage t_algorithm_lib:string function_parser.temp.list_check{char:["tan("]} run scoreboard players set #tal.str.temp.success tal.input 1
execute if data storage t_algorithm_lib:string function_parser.temp.list_check{char:["ln("]} run scoreboard players set #tal.str.temp.success tal.input 1
...
execute if score #tal.str.temp.success tal.input matches 1 if score #tal.str.temp.success2 tal.input matches 1 if score #tal.str.temp.success3 tal.input matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/function_name/c_num

data remove storage t_algorithm_lib:string function_parser.temp.list[0]

execute store result score #tal.str.temp.list_count tal.input run data get storage t_algorithm_lib:string function_parser.temp.list
execute if score #tal.str.temp.list_count tal.input matches 1.. run function t_algorithm_lib:string/function_parser/parser/start_from_x/function_name/start