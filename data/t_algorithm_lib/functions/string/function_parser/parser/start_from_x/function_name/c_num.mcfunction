...
execute store result score #tal.str.temp.num2 tal.str_parser run data get storage t_algorithm_lib:string function_parser.temp.list[1][0] 100000
...
scoreboard players operation #tal.num.temp.num_b tal.str_parser = #tal.str.temp.num2 tal.str_parser
