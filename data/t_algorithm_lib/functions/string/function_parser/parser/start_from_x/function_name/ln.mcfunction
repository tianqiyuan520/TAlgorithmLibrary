execute store result score #tal.str.temp.num2 tal.input run data get storage t_algorithm_lib:string function_parser.temp.list[1][0] 1000
scoreboard players operation #tal.num.ln.num1 tal.input = #tal.str.temp.num2 tal.input
