...
scoreboard players set #tal.str.temp.success5 tal.input 0
...
execute if data storage t_algorithm_lib:string function_parser.temp.list_check{char:["+"]} run scoreboard players set #tal.str.temp.success3 tal.input 1
execute if data storage t_algorithm_lib:string function_parser.temp.list_check{char:["+"]} run scoreboard players set #tal.str.temp.is_add tal.input 1
...
execute unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["+"]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["-"]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["*"]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["/"]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["^"]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["("]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:[")"]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["sin("]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["cos("]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["tan("]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["ln("]} run scoreboard players set #tal.str.temp.success4 tal.input 1
...
execute unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["*"]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["/"]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["^"]} run scoreboard players set #tal.str.temp.success5 tal.input 1
...
execute unless score #tal.str.temp.success5 tal.input matches 1 run scoreboard players set #tal.str.temp.fail tal.input 1
...
execute if score #tal.str.temp.success tal.input matches 1 if score #tal.str.temp.success2 tal.input matches 1 if score #tal.str.temp.success3 tal.input matches 1 if score #tal.str.temp.success4 tal.input matches 1 if score #tal.str.temp.success5 tal.input matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/c_num_2