...
scoreboard players set #tal.str.temp.is_add tal.input 0
...
# execute if score #tal.str.temp.list_count_b tal.input = #tal.str.temp.list_count tal.input if score #tal.str.temp.success tal.input matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/check
execute if score #tal.str.temp.list_count_b tal.input = #tal.str.temp.list_count tal.input if score #tal.str.temp.success tal.input matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/check
execute if score #tal.str.temp.list_count_b tal.input = #tal.str.temp.list_count tal.input unless score #tal.str.temp.success tal.input matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/check_2

execute if score #tal.str.temp.is_operation tal.input matches 0 unless score #tal.str.temp.list_count_b tal.input = #tal.str.temp.list_count tal.input run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/check_2
...
execute store result score #tal.str.temp.list_count tal.input run data get storage t_algorithm_lib:string function_parser.temp.list
execute if score #tal.str.temp.list_count tal.input matches 1.. run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/start