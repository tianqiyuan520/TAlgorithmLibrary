...
scoreboard players set #tal.str.temp.is_add tal.str_parser 0
...
# execute if score #tal.str.temp.list_count_b tal.str_parser = #tal.str.temp.list_count tal.str_parser if score #tal.str.temp.success tal.str_parser matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/check
execute if score #tal.str.temp.list_count_b tal.str_parser = #tal.str.temp.list_count tal.str_parser if score #tal.str.temp.success tal.str_parser matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/check
execute if score #tal.str.temp.list_count_b tal.str_parser = #tal.str.temp.list_count tal.str_parser unless score #tal.str.temp.success tal.str_parser matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/check_2

execute if score #tal.str.temp.is_operation tal.str_parser matches 0 unless score #tal.str.temp.list_count_b tal.str_parser = #tal.str.temp.list_count tal.str_parser run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/check_2
...
execute store result score #tal.str.temp.list_count tal.str_parser run data get storage t_algorithm_lib:string function_parser.temp.list
execute if score #tal.str.temp.list_count tal.str_parser matches 1.. run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/start