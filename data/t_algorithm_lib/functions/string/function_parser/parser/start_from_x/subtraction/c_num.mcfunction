...
##计算
execute if score #tal.str.func_p.scale tal.str_parser matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/high_cal_1
execute if score #tal.str.func_p.scale tal.str_parser matches 0 run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/low_cal_1
