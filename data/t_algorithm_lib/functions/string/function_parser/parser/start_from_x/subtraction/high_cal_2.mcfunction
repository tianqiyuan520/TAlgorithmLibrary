...
scoreboard players set #tal.str.temp.negative tal.str_parser 0
...
execute if data storage t_algorithm_lib:string function_parser.temp.list_check{char:["-"]} run scoreboard players set #tal.str.temp.negative tal.str_parser 1
...
execute if data storage t_algorithm_lib:string function_parser.temp.list_check{char:"-"} if score #tal.str.temp.negative tal.str_parser matches 1 run data remove storage t_algorithm_lib:num double_calculation.temp.num1[0]
execute if score #tal.str.temp.negative tal.str_parser matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/add_negative
