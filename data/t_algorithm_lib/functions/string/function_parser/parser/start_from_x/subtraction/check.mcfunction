...
execute unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["*"]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["/"]} unless data storage t_algorithm_lib:string function_parser.temp.list_check{char:["^"]} run scoreboard players set #tal.str.temp.success4 tal.input 1
...
execute if score #tal.str.temp.success tal.input matches 1 if score #tal.str.temp.success2 tal.input matches 1 if score #tal.str.temp.success3 tal.input matches 1 if score #tal.str.temp.success4 tal.input matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/subtraction/c_num
