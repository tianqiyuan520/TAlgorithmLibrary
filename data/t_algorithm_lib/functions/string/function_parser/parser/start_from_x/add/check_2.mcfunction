...
execute if score #tal.str.temp.success tal.input matches 1 if score #tal.str.temp.success2 tal.input matches 1 if score #tal.str.temp.success3 tal.input matches 1 if score #tal.str.temp.success4 tal.input matches 1 if score #tal.str.temp.success5 tal.input matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/add/c_num_2