...
# execute if score #tal.str.temp.list_count_b tal.input = #tal.str.temp.list_count tal.input if score #tal.str.temp.success tal.input matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/add/check
execute if score #tal.str.temp.list_count_b tal.input = #tal.str.temp.list_count tal.input if score #tal.str.temp.success tal.input matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/add/check
execute if score #tal.str.temp.list_count_b tal.input = #tal.str.temp.list_count tal.input unless score #tal.str.temp.success tal.input matches 1 run function t_algorithm_lib:string/function_parser/parser/start_from_x/add/check_2
execute unless score #tal.str.temp.list_count_b tal.input = #tal.str.temp.list_count tal.input run function t_algorithm_lib:string/function_parser/parser/start_from_x/add/check_2
...
execute store result score #tal.str.temp.list_count tal.input run data get storage t_algorithm_lib:string function_parser.temp.list
execute if score #tal.str.temp.list_count tal.input matches 1.. run function t_algorithm_lib:string/function_parser/parser/start_from_x/add/start