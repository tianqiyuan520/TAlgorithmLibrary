execute if score #tal.str.temp.is_doit tal.input matches 0 run data modify storage t_algorithm_lib:string function_parser.temp.list append value ['.']
execute if score #tal.str.temp.is_doit tal.input matches 0 run data modify storage t_algorithm_lib:string function_parser.temp.list append value [0]
...
##移除多余符号
scoreboard players set #tal.str.temp.is_n tal.input 0
scoreboard players set #tal.str.temp.is_remove tal.input 0
...
execute if score #tal.str.temp.is_remove tal.input matches 1 run scoreboard players set #tal.str.temp.is_n tal.input 1
execute if data storage t_algorithm_lib:string function_parser.temp.list_check{char:["+"]} run function t_algorithm_lib:string/function_parser/parser/separate/check_symbol
##
...
execute if score #tal.str.temp.is_remove tal.input matches 1 run data remove storage t_algorithm_lib:string function_parser.separation[-1]
execute if score #tal.str.temp.is_n tal.input matches 1 run scoreboard players set #tal.num.hpc.num3_pn tal.input -1
...
execute unless score #tal.str.temp.list_count2 tal.input matches 0 run function t_algorithm_lib:string/function_parser/parser/separate/check_tier
