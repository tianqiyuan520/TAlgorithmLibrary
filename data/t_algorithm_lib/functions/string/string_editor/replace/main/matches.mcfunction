...
execute store result score #tal.str.strEDIT.replace.str3_len tal.str_parser run data get storage t_algorithm_lib:string string_editor.replace.io.input.string2