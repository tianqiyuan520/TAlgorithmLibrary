...
execute if score #tal.sign_version tal.input matches 2 run execute positioned -29999999.42 4.64 2022228.75 run data modify block ~ ~ ~ front_text.messages[0] set value '{"nbt":"io.input","storage":"t_algorithm_lib:string_parser"}'
...
###自定义参数
#读取玩家设置的循环次数
execute store result score #tal.str_p.char.TotalLimlit tal.input run data get storage t_algorithm_lib:string_parser io.parameter.limitTime
#读取玩家设置的 拆解的字符限制个数
execute store result score #tal.str_p.char.len tal.input run data get storage t_algorithm_lib:string_parser io.parameter.len
#是否启动计时器
execute store result score #tal.str_p.char.timer_on tal.input run data get storage t_algorithm_lib:string_parser io.parameter.timer
#是否启动 拆解开头与结果告知
execute store result score #tal.str_p.char.printable tal.input run data get storage t_algorithm_lib:string_parser io.parameter.printable
####

#检测大小 tag list中前后位置
scoreboard players set #tal.str_p.char.bigger tal.input 0
scoreboard players set #tal.str_p.char.bigger2 tal.input 0


#设置循环次数限制 防止死循环
scoreboard players set #tal.str_p.char.limlit tal.input 0

#设置 是否成功
scoreboard players set #tal.str_p.char.success tal.input 0
...
###
scoreboard players set #tal.str_p.char.IsChanged tal.input 1
#解决特殊字符所用计分板
...
#重置计时
scoreboard players set #tal.str_p.char.timer tal.input 0
function t_algorithm_lib:string/string_parser/string/dichotomy/index/reset
scoreboard players set #tal.str_p.char.solveCount tal.input 0
scoreboard players set #tal.str_p.char.stop tal.input 0
...
scoreboard players set #tal.str_p.char.IsChanged_ tal.input 0
scoreboard players set #tal.str_p.list_to_string.count_last_ tal.input 0
scoreboard players set #tal.str_p.list_to_string.count_last tal.input 0
scoreboard players set #tal.str_p.char.IsChanged_ tal.input 0
scoreboard players set #tal.str_p.char.re_read tal.input 0
scoreboard players set #tal.str_p.char.re_read_check tal.input 0

execute if score #tal.str_p.char.printable tal.input matches 1 run tellraw @p [{"text":"[TDictionary] ","color": "#a8a8a8"},{"text":"[","color": "white"},{"text":"点击查看","color": "yellow","clickEvent": {"action": "suggest_command","value": "/data get storage t_algorithm_lib:string_parser io.output"},"bold": true},{"text":"]","color": "white"}]
