...
execute store result score #tal.str_p.char_to_id.count tal.input run data modify block -30000000 4 2022228 front_text.messages[2] set value '[{"nbt":"temp.result[0]","storage":"t_algorithm_lib:string_parser","interpret":true},{"nbt":"temp.result[1]","storage":"t_algorithm_lib:string_parser"}]'
...
execute store result score #tal.str_p.char_to_id.count tal.input run execute if score #tal.str_p.array.IsFail tal.input matches 0 run data modify block -30000000 4 2022228 front_text.messages[2] set value '[{"nbt":"temp.result[0]","storage":"t_algorithm_lib:string_parser","interpret":true},{"text":"\\n"}]'


execute if score #tal.str_p.list_to_string.count_last tal.input < #tal.str_p.list_to_string.count_ tal.input if score #tal.str_p.list_to_string.count_ tal.input matches 2.. if score #tal.str_p.list_to_string.count tal.input matches 2 run data modify storage t_algorithm_lib:string_parser temp.result_last set from storage t_algorithm_lib:string_parser temp.result[0]
execute store result score #tal.str_p.list_to_string.count tal.input run data get storage t_algorithm_lib:string_parser temp.chars
data modify storage t_algorithm_lib:string_parser temp.result[0] set from block -30000000 4 2022228 Text3
execute store result score #tal.str_p.char_to_id.count tal.input run data modify storage t_algorithm_lib:string_parser temp.result[0] set from block -30000000 4 2022228 front_text.messages[2]
...
execute if score #tal.str_p.list_to_string.count tal.input matches 1.. run function t_algorithm_lib:string/string_parser/string/dichotomy/test