...
execute unless score #tal.str_p.char.re_read tal.str_parser matches 10 run scoreboard players set #tal.str_p.char.re_read tal.str_parser 0


##########################处理 " ","!" 特殊字符###################
function t_algorithm_lib:string/string_parser/string/dichotomy/index/reset

scoreboard players set #tal.str_p.SpecialChar tal.str_parser 1
