...
scoreboard players operation #tal.str_p.char_to_id.char tal.input = #tal.str_p.char_to_id.countMax tal.input
scoreboard players operation #tal.str_p.char_to_id.char tal.input -= #tal.str_p.char_to_id.count tal.input
scoreboard players remove #tal.str_p.char_to_id.char tal.input 1

#此时 #tal.str_p.char_to_id.char tal.input为index 即该 玩家字符应添加至index前一位
...
#数值index:
scoreboard players operation #tal.str_p.array.indexMax tal.input = #tal.str_p.char_to_id.char tal.input
#循环的index
scoreboard players set #tal.str_p.array.index tal.input 0
#数组
