...
# execute if score #tal.str_p.list_to_string.count_last tal.str_parser < #tal.str_p.list_to_string.count_ tal.str_parser if score #tal.str_p.list_to_string.count_ tal.str_parser matches 2.. if score #tal.str_p.list_to_string.count tal.str_parser matches 2 run scoreboard players operation #tal.str_p.list_to_string.count_last_ tal.str_parser = #tal.str_p.list_to_string.count_ tal.str_parser
# execute if score #tal.str_p.list_to_string.count_last tal.str_parser < #tal.str_p.list_to_string.count_ tal.str_parser if score #tal.str_p.list_to_string.count_ tal.str_parser matches 2.. if score #tal.str_p.list_to_string.count tal.str_parser matches 2 run scoreboard players add #tal.str_p.list_to_string.count_last_ tal.str_parser 1

execute store result score #tal.str_p.list_to_string.count tal.str_parser run data get storage t_algorithm_lib:string_parser temp.chars

data modify storage t_algorithm_lib:string_parser temp.result[0] set from block -30000000 4 2022228 Text3

execute if score #tal.str_p.list_to_string.count_last tal.str_parser < #tal.str_p.list_to_string.count_ tal.str_parser if score #tal.str_p.list_to_string.count_ tal.str_parser matches 3.. if score #tal.str_p.list_to_string.count tal.str_parser matches 3 run data modify storage t_algorithm_lib:string_parser temp.result_last set from storage t_algorithm_lib:string_parser temp.result[0]
...
#递归
execute if score #tal.str_p.list_to_string.count tal.str_parser matches 1.. run function t_algorithm_lib:string/string_parser/string/dichotomy/list_to_string