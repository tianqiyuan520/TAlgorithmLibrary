...
execute if score #tal.str_p.char.printable tal.str_parser matches 1 if score #tal.str_p.char.timer_on tal.str_parser matches 1 run function t_algorithm_lib:string/string_parser/timer/show
scoreboard players set #tal.str_p.char.stop tal.str_parser 1
