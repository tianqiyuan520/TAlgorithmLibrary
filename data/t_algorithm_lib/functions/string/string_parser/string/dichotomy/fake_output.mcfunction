...
execute if score #tal.sign_version tal.input matches 2 run data modify block -30000000 4 2022228 front_text.messages[1] set value '[{"nbt":"LastOutput","block":"-29999999 2 2022227","interpret":true,"separator":""},{"text":"","extra":[{"translate":"commands.tag.list.single.success","with":["",{"text":"2"}]}]},{"nbt":"LastOutput","block":"-30000000 2 2022229"},{"text":", "},{"nbt":"LastOutput","block":"-30000000 2 2022230"}]'


data modify entity 00000000-0000-1d63-0000-000000000001 CustomName set from block -30000000 4 2022228 Text2
execute if score #tal.sign_version tal.input matches 2 run data modify entity 00000000-0000-1d63-0000-000000000001 CustomName set from block -30000000 4 2022228 front_text.messages[1]
