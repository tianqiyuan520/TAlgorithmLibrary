...
##指针
scoreboard players set #tal.str.kmp.index tal.str_parser 1
##数据 next数组
...
scoreboard players set #tal.str.kmp.index2 tal.str_parser 0
scoreboard players set #tal.str.kmp.num tal.str_parser 0
...
##循环匹配
##主串 指针
scoreboard players set #tal.str.kmp.index tal.str_parser 0
##子串 指针
scoreboard players set #tal.str.kmp.index2 tal.str_parser 0
