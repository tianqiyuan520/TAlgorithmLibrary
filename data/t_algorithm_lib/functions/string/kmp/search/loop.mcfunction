...
##如果匹配
execute if score #tal.str.kmp.check tal.str_parser matches 0 run scoreboard players add #tal.str.kmp.index tal.str_parser 1
execute if score #tal.str.kmp.check tal.str_parser matches 0 run scoreboard players add #tal.str.kmp.index2 tal.str_parser 1

execute if score #tal.str.kmp.check tal.str_parser matches 1 if score #tal.str.kmp.index2 tal.str_parser matches 1.. run function t_algorithm_lib:string/kmp/search/failure
execute if score #tal.str.kmp.check tal.str_parser matches 1 unless score #tal.str.kmp.index2 tal.str_parser matches 1.. run scoreboard players add #tal.str.kmp.index tal.str_parser 1

##查看是否全匹配 ，子串指针==子串个数
execute store result score #tal.str.kmp.list_count tal.str_parser run data get storage t_algorithm_lib:string kmp.list2
execute if score #tal.str.kmp.index2 tal.str_parser = #tal.str.kmp.list_count tal.str_parser run function t_algorithm_lib:string/kmp/search/success_all



execute store result score #tal.str.kmp.list_count tal.str_parser run data get storage t_algorithm_lib:string kmp.list1
execute if score #tal.str.kmp.index tal.str_parser < #tal.str.kmp.list_count tal.str_parser run function t_algorithm_lib:string/kmp/search/loop