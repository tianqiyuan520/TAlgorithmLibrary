...
##转化为double
data modify storage t_algorithm_lib:num double_compare.list set value [0.0]
execute store success score #tal.num.double_compare.check tal.input run data modify storage t_algorithm_lib:num double_compare.list append from storage t_algorithm_lib:num double_compare.input.num
execute if score #tal.num.double_compare.check tal.input matches 0 store result storage t_algorithm_lib:num double_compare.input.num double 1.0 run data get storage t_algorithm_lib:num double_compare.input.num
execute store success score #tal.num.double_compare.check tal.input run data modify storage t_algorithm_lib:num double_compare.list append from storage t_algorithm_lib:num double_compare.input.num2
execute if score #tal.num.double_compare.check tal.input matches 0 store result storage t_algorithm_lib:num double_compare.input.num2 double 1.0 run data get storage t_algorithm_lib:num double_compare.input.num2
#生成实体
