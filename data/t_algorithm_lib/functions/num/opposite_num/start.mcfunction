...
##[自定义输入]double_array
execute if score #tal.array.double_to_array.negative tal.str_parser matches 0 run scoreboard players set #tal.array.DAToDouble.negative tal.str_parser -1
execute if score #tal.array.double_to_array.negative tal.str_parser matches 1 run scoreboard players set #tal.array.DAToDouble.negative tal.str_parser 1
