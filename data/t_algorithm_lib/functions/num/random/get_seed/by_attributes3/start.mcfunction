...
execute positioned -29999990 10 2022237 store result score #tal.num.random.seed tal.str_parser run data get block ~ ~ ~ Items[0].tag.AttributeModifiers[0].Amount 1000
