...
execute positioned -29999999 0 2022245 as @e[limit=1,distance=..1,tag=tal.num.random.seed] store result score #tal.num.random.seed tal.str_parser run data get entity @s Item.tag.AttributeModifiers[0].Amount
