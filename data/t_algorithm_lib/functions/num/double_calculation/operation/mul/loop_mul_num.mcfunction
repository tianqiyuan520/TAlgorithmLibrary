scoreboard players add #tal.num.hpc.mul_zero_time tal.str_parser 1
scoreboard players operation #tal.num.hpc.mul_zero_time_ tal.str_parser = #tal.num.hpc.mul_zero_time tal.str_parser

execute if score #tal.num.hpc.mul_zero_time_ tal.str_parser matches 2.. run function t_algorithm_lib:num/double_calculation/operation/mul/add_zero
...
execute if score #tal.num.hpc.list_count1 tal.str_parser matches 1.. if score #tal.num.hpc.list_num2 tal.str_parser matches 1.. run function t_algorithm_lib:num/double_calculation/operation/mul/loop
