...
execute store result score #tal.num.hpc.list_count1 tal.input run data get storage t_algorithm_lib:num double_calculation.mul_result3
execute if score #tal.num.hpc.list_count1 tal.input matches 2.. run function t_algorithm_lib:num/double_calculation/operation/mul/add_loop
