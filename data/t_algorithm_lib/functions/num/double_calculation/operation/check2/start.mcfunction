...
execute if score #tal.num.hpc.check_s tal.input matches 0 if score #tal.num.hpc.list_count1 tal.input = #tal.num.hpc.list_count2 tal.input run function t_algorithm_lib:num/double_calculation/operation/check2/loop
