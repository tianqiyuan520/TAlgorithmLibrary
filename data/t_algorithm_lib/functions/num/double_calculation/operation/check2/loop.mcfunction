...
execute if score #tal.num.hpc.list_count1 tal.input matches 1.. if score #tal.num.hpc.list_num1 tal.input >= #tal.num.hpc.list_num2 tal.input run function t_algorithm_lib:num/double_calculation/operation/check2/loop
