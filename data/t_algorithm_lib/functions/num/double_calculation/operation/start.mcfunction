...
##判断正负
scoreboard players set #tal.num.hpc.num1_pn tal.str_parser 1
scoreboard players set #tal.num.hpc.num2_pn tal.str_parser 1
##结果的正负
...
execute if data storage t_algorithm_lib:num double_calculation.list_check{char:["-"]} run scoreboard players set #tal.num.hpc.num1_pn tal.str_parser -1
...
execute if data storage t_algorithm_lib:num double_calculation.list_check{char:["-"]} run scoreboard players set #tal.num.hpc.num2_pn tal.str_parser -1

##去除 "." 且将 [[1],[2]] 转化为数字数组 [1,2]
scoreboard players set #tal.num.hpc.num1_p tal.str_parser 0
scoreboard players set #tal.num.hpc.num2_p tal.str_parser 0
...
execute if score #tal.num.hpc.SFIB tal.str_parser matches 1.. run function t_algorithm_lib:num/double_calculation/operation/if_sfib
...
execute if score #tal.num.hpc.num1_p tal.str_parser matches -1 run data modify storage t_algorithm_lib:num double_calculation.temp.num1 append value 0
execute if score #tal.num.hpc.num1_p tal.str_parser matches -1 run scoreboard players set #tal.num.hpc.num1_p tal.str_parser 1

execute if score #tal.num.hpc.SFIB tal.str_parser matches 1.. run function t_algorithm_lib:num/double_calculation/operation/restart_num1
...
scoreboard players operation #tal.num.hpc.num2_p tal.str_parser = #tal.num.hpc.num1 tal.str_parser

##如果不是double
execute if score #tal.num.hpc.num2_p tal.str_parser matches -1 run data modify storage t_algorithm_lib:num double_calculation.temp.num2 append value 0
execute if score #tal.num.hpc.num2_p tal.str_parser matches -1 run scoreboard players set #tal.num.hpc.num2_p tal.str_parser 1

execute if score #tal.num.hpc.SFIB tal.str_parser matches 1.. run function t_algorithm_lib:num/double_calculation/operation/restart_num2

# tellraw @a [{"text": "小数进位个数: "},{"score":{"name": "#tal.num.hpc.num1_p","objective": "tal.str_parser"},"color": "red"},{"score":{"name": "#tal.num.hpc.num2_p","objective": "tal.str_parser"},"color": "blue"}]

##运算
execute store result score #tal.num.hpc.operation tal.str_parser run data get storage t_algorithm_lib:num double_calculation.operation

##最终结果
data modify storage t_algorithm_lib:num double_calculation.temp.result set value []

##加法
execute if score #tal.num.hpc.operation tal.str_parser matches 1 run function t_algorithm_lib:num/double_calculation/operation/add/check
##减法
execute if score #tal.num.hpc.operation tal.str_parser matches 2 run function t_algorithm_lib:num/double_calculation/operation/subtraction/check
##乘法
execute if score #tal.num.hpc.operation tal.str_parser matches 3 run function t_algorithm_lib:num/double_calculation/operation/mul/check
##除法
execute if score #tal.num.hpc.operation tal.str_parser matches 4 run function t_algorithm_lib:num/double_calculation/operation/division/check
...
##除法是否本tick执行(默认关)
scoreboard players set #tal.num.hpc.division_continue tal.str_parser 0
##除法 (1/x)精度(默认8)
scoreboard players set #tal.num.hpc.division_precision tal.str_parser 8
##是否忽略小数八位以后
scoreboard players set #tal.num.hpc.ignore_eight tal.str_parser 0
