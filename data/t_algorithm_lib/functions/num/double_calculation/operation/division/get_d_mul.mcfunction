...
scoreboard players set #tal.num.hpc.division_first tal.input 0
function t_algorithm_lib:num/double_calculation/operation/division/get_d_mul_loop_f
##
function t_algorithm_lib:num/double_calculation/operation/division/get_d_mul_loop

##循环结束 将 被除数减去
execute store result storage t_algorithm_lib:num double_calculation.division_result[-1] int 1 run scoreboard players get #tal.num.hpc.division_mul_1 tal.input
##减法
...
# tellraw @a ["选择到的除数",{"score":{"name": "#tal.num.hpc.division_mul_1","objective": "tal.input"}},{"nbt":"double_calculation.division.num1","storage": "t_algorithm_lib:num","color": "red"},{"nbt":"double_calculation.division.num4","storage": "t_algorithm_lib:num","color": "blue"},{"nbt":"double_calculation.remove_l.num1","storage": "t_algorithm_lib:num","color": "yellow"}]
