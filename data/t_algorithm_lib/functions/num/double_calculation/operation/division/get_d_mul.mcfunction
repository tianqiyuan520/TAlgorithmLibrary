...
scoreboard players set #tal.num.hpc.division_first tal.str_parser 0
...
# tellraw @a ["选择到的除数",{"score":{"name": "#tal.num.hpc.division_mul_1","objective": "tal.str_parser"}},{"nbt":"double_calculation.division.num1","storage": "t_algorithm_lib:num","color": "red"},{"nbt":"double_calculation.division.num4","storage": "t_algorithm_lib:num","color": "blue"},{"nbt":"double_calculation.remove_l.num1","storage": "t_algorithm_lib:num","color": "yellow"}]
