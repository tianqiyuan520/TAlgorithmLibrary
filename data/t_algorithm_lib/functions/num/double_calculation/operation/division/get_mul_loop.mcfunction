...
# execute store result storage t_algorithm_lib:num double_calculation.mul_simple.num2[0] int 1 run scoreboard players get #tal.num.hpc.division_mul_time tal.input
