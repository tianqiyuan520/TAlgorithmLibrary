...
execute if score #tal.num.hpc.list_count tal.str_parser matches 1.. run function t_algorithm_lib:num/double_calculation/operation/division/add_point/loop