...
execute if score #tal.num.hpc.add_point tal.str_parser matches 1 if score #tal.num.hpc.list_count tal.str_parser matches 1 run data modify storage t_algorithm_lib:num double_calculation.add_point.result append value [0]
