...
execute if score #tal.num.hpc.list_num1 tal.str_parser = #tal.num.hpc.list_num2 tal.str_parser run scoreboard players add #tal.num.hpc.check_e tal.str_parser 1
...
execute if score #tal.num.hpc.list_count1 tal.str_parser matches 1.. if score #tal.num.hpc.list_num1 tal.str_parser = #tal.num.hpc.list_num2 tal.str_parser run function t_algorithm_lib:num/double_calculation/operation/check/loop
