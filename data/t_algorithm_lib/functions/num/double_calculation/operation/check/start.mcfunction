...
scoreboard players set #tal.num.hpc.check_s_ tal.str_parser 0
##记录等于的次数
scoreboard players set #tal.num.hpc.check_e tal.str_parser 0

execute store result score #tal.num.hpc.list_count2 tal.str_parser run data get storage t_algorithm_lib:num double_calculation.check.num1
...
execute if score #tal.num.hpc.check_e tal.str_parser = #tal.num.hpc.list_count2 tal.str_parser run scoreboard players set #tal.num.hpc.check_s tal.str_parser 1