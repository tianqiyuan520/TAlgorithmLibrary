##获取n
execute store result score #tal.num.double_factorial.num tal.str_parser run data get storage t_algorithm_lib:num double_factorial.input.num
scoreboard players add #tal.num.double_factorial.num tal.str_parser 1
scoreboard players operation #tal.num.double_factorial.num tal.str_parser /= #2 tal.str_parser

##(2n)! / 2^n*n!
execute store result storage t_algorithm_lib:num factorial_high.input.num double 1.0 run scoreboard players get #tal.num.double_factorial.num tal.str_parser
...
##[自定义]指数
execute store result storage t_algorithm_lib:num exponentiation_by_squaring.input.num2 double 1.0 run scoreboard players get #tal.num.double_factorial.num tal.str_parser
