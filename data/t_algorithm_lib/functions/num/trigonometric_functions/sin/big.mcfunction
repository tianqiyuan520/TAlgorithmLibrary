...
execute if score #tal.num.temp.x tal.input matches 314159261.. run function t_algorithm_lib:num/trigonometric_functions/sin/is_large
# scoreboard players operation #tal.num.temp.x tal.input -= #tal.num.temp.2pi tal.input

# execute store result storage t_algorithm_lib:num temp.x double 0.0001 run scoreboard players get #tal.num.temp.x tal.input
