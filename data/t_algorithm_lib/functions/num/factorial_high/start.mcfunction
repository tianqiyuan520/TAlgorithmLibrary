...
##
scoreboard players set #tal.num.factorial_high.num tal.input 2
execute store result score #tal.num.factorial_high.max tal.input run data get storage t_algorithm_lib:num factorial_high.input.num

##返回结果
data modify storage t_algorithm_lib:num factorial_high.result set value 0.0d

execute if score #tal.num.factorial_high.max tal.input matches ..1 run data modify storage t_algorithm_lib:num factorial_high.result set value 1d
data modify storage t_algorithm_lib:num double_calculation.temp.result set value [[1],['.'],[0]]

execute if score #tal.num.factorial_high.max tal.input matches 2.. run function t_algorithm_lib:num/factorial_high/loop
