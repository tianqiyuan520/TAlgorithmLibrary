...
execute store result storage t_algorithm_lib:array double_to_array.num double 1.0 run scoreboard players get #tal.num.factorial_high.num tal.input
...
scoreboard players add #tal.num.factorial_high.num tal.input 1
scoreboard players remove #tal.num.factorial_high.max tal.input 1
