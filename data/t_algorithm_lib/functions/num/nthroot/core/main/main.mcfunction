...
execute store result score #tal.num.temp.power tal.str_parser run data get storage t_algorithm_lib:num nthroot.core.function[2][0]
...
execute if score #tal.num.hpc.num3_pn tal.str_parser matches -1 run data modify storage t_algorithm_lib:num nthroot.core.cal_list[-1] prepend value ['-'] 
...
##解析二
data modify storage t_algorithm_lib:string function_parser.temp.list[0][0] set from storage t_algorithm_lib:num nthroot.core.x_list[-1]
execute store result score #tal.num.temp.power tal.str_parser run data get storage t_algorithm_lib:num nthroot.core.function2[4][0]
function t_algorithm_lib:string/function_parser/parser/start_from_x/power/num_any_power/start
##乘
...
scoreboard players set #tal.num.hpc.division_precision tal.str_parser 12
function t_algorithm_lib:num/double_calculation/operation/start
...
function t_algorithm_lib:num/nthroot/core/main/loop_sp
execute if score #tal.num.hpc.num3_pn tal.str_parser matches -1 run data modify storage t_algorithm_lib:num nthroot.temp.n1 prepend value "-"
scoreboard players set #tal.num.hpc.ignore_eight tal.str_parser 1
data modify storage t_algorithm_lib:num double_calculation.temp.num2 set from storage t_algorithm_lib:num nthroot.temp.n1
function t_algorithm_lib:num/double_calculation/operation/start
...
##误差判断error
execute if score #tal.num.nthroot.core.i tal.str_parser matches 4.. run function t_algorithm_lib:num/nthroot/core/main/error

scoreboard players add #tal.num.nthroot.core.i tal.str_parser 1
execute if score #tal.num.nthroot.core.loop_end tal.str_parser matches 0 if score #tal.num.nthroot.core.i tal.str_parser matches ..100 run function t_algorithm_lib:num/nthroot/core/main/main