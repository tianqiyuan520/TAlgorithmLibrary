...
scoreboard players set #tal.num.nthroot.is_z tal.input 1
...
##底数
execute store result score #tal.num.nthroot.num2 tal.input run data get storage t_algorithm_lib:num nthroot.main.stack[-1].num1
# tellraw @a ["指数: ",{"score":{"name": "#tal.num.nthroot.num1","objective": "tal.input"},"color":"green"}]
