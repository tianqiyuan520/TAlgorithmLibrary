...
execute store result storage t_algorithm_lib:num nthroot.main.stack[-1].last double 1.0 run scoreboard players get #tal.num.nthroot.num_s tal.str_parser
execute store result storage t_algorithm_lib:num nthroot.main.stack[-1].num2 double 1.0 run scoreboard players operation #tal.num.nthroot.num1 tal.str_parser /= #tal.num.nthroot.num_s tal.str_parser