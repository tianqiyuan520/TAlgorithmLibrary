...
scoreboard players set #tal.num.nthroot.num tal.str_parser 1

##[自定义]终止运算数
# scoreboard players set #tal.num.nthroot.i2 tal.str_parser 10000
##[自定义]是否提醒"运算结束"
# scoreboard players set #tal.num.nthroot.remind tal.str_parser 0
scoreboard players set #tal.num.nthroot.i tal.str_parser 0
