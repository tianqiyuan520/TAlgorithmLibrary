...
execute store result storage t_algorithm_lib:num exponentiation_by_squaring.main.stack[-1].num2 int 1 run scoreboard players remove #tal.num.exponentiation_by_squaring.num1 tal.str_parser 1
# function t_algorithm_lib:num/exponentiation_by_squaring/main/main
scoreboard players set #tal.num.exponentiation_by_squaring.is_o tal.str_parser 1
